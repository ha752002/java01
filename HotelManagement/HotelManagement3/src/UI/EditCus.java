...
public class EditCus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(dob, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 220, 315, 31));
        ...
        btnOk.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/icons8_verified_account_32px_2.png"))); // NOI18N
        btnOk.setText("Confirmed");
        btnOk.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnOkActionPerformed(evt);
            }
        });
        jPanel1.add(btnOk, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 500, 136, 56));
        ...
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 220, 100, 30));

        jLabel11.setBackground(new java.awt.Color(0, 0, 0));
        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel11.setText("Gender");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 290, 100, 30));
        ...
        jPanel1.add(cbgender, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 290, 111, 36));

        jLabel10.setBackground(new java.awt.Color(0, 0, 0));
        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel10.setText("Phone");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 160, 100, 30));
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(cus_name.equals("")||mobile.equals("")||address.equals("")){
            ...
            Customer customerMn = new Customer(cus_id, cus_name, mobile,birthday, gender, address);
              CustomerManagement.update(customerMn);
              dispose();
            }
    ...
    void setEditData(Customer customerMn) {
        cus_id = customerMn.getId();
        name.setText(customerMn.getName());
        phone.setText(customerMn.getPhone());
        dob.setText(customerMn.getBirthday());
        cbgender.setSelectedItem(customerMn.getGender());
        add.setText(customerMn.getAddress());
