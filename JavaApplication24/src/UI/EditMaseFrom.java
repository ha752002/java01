 ...
 * @author admin
 */
public class EditMaseFrom extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 370, 315, 31));
        ...
        jPanel1.add(txt3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 230, 315, 31));
        ...
        jPanel1.add(gender, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 300, 111, 36));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditMaseFrom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditMaseFrom().setVisible(true);
            }
        });
    }
